 ...
 */
function initializeRoutes(controller, auth-middleware) {
   ...
   */
  router.get('/stats', auth-middleware, (req, res) => controller.getCertificateStats(req, res));
   ...
   * @access  Private (Admin/Staff)
   */
  router.get('/expiring', auth-middleware, (req, res) =>
   ...
   * @access  Private
   */
  router.get('/number/:certificateNumber', auth-middleware, (req, res) =>
   ...
   * @access  Private
   */
  router.get('/user/:userId', auth-middleware, (req, res) =>
   ...
   * @access  Private
   */
  router.get('/:id', auth-middleware, (req, res) => controller.getCertificateById(req, res));
   ...
   * @access  Private (Admin/Staff)
   */
  router.get('/', auth-middleware, (req, res) => controller.getAllCertificates(req, res));
   ...
   * @access  Private (Admin/Staff)
   */
  router.post('/', auth-middleware, (req, res) => controller.createCertificate(req, res));
   ...
   * @access  Private (Admin/Staff)
   */
  router.post('/:id/renew', auth-middleware, (req, res) => controller.renewCertificate(req, res));
   ...
   */
  router.post('/:id/revoke', auth-middleware, (req, res) => controller.revokeCertificate(req, res));
   ...
   */
  router.put('/:id/pdf', auth-middleware, (req, res) => controller.updatePDFInfo(req, res));
