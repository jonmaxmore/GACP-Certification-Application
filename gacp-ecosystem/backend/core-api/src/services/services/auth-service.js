...
class auth-service {
    ...
    async register(data) {
        ...
        console.log('[auth-service] Registering:', accountType, data.firstName || data.companyName || data.communityName);
    ...
    async login(identifier, password, accountType = null) {
        console.log('[auth-service] Login attempt:', { identifier, accountType });
        let user;
