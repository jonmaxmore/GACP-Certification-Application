...
async function createCannabisTemplates(createdBy = null) {
  try {
    ...
    logger.error('Error creating cannabis templates:', error);
    throw error;
  }
}
...
async function createIndividualTemplate(templateIndex, createdBy = null) {
  try {
    ...
    logger.error('Error creating individual cannabis template:', error);
    throw error;
  }
}
...
async function updateTemplateQuestions(templateId, newQuestions) {
  try {
    ...
    logger.error('Error updating template questions:', error);
    throw error;
  }
}
