...
import { useWizardStore, SiteData } from '../hooks/useWizardStore';
...
export const StepLand = () => {
    ...
    // Local state for form - use Partial type for flexible form handling
    const [formData, setFormData] = useState<Partial<SiteData>>(state.siteData || {
        siteName: '',
        address: '',
        province: '',
        district: '',
    ...
    useEffect(() => {
        ...
        const timeout = setTimeout(() => {
            if (formData.siteName) {
                setSiteData(formData as SiteData);
            }
        }, 500);
    ...
    return (
        <div className="space-y-8 animate-fadeIn">
                    ...
                    <div className="border-t pt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={e => handleChange('landOwnership', e.target.value as 'OWN' | 'RENT' | 'CONSENT')}
                            >
            ...
            <div className="flex justify-between pt-6 border-t mt-8">
                <button
                    onClick={() => router.push('/farmer/applications/new/step/2')}
                ...
                <button
                    ...
                    disabled={!formData.siteName || !formData.province}
                    className={`
                        px-8 py-2 rounded-lg font-medium shadow-sm transition-all
                        ${(!formData.siteName || !formData.province)
