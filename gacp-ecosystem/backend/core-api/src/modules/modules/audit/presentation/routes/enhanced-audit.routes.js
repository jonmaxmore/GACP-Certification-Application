 ...
 */
function createEnhancedAuditRoutes(auditController, auth-middleware) {
  ...
  dtamRouter.get(
    ...
    auth-middleware.requireRole(['admin', 'dtam_staff', 'compliance_officer']),
  ...
  dtamRouter.post(
    ...
    auth-middleware.requireAuth,
    auth-middleware.requireRole(['admin', 'system_admin']),
