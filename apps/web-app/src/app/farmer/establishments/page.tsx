        ...
        <div className="p-6 lg:p-10 pb-24 lg:pb-10 max-w-4xl mx-auto">
            ...
            {!loading && !error && farms.length === 0 && (
                <div className={`rounded-2xl p-12 text-center ${isDark ? 'bg-slate-800 border border-slate-700' : 'bg-white border border-slate-200'}`}>
                    ...
                    <Link href="/farmer/applications/new" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-br from-emerald-600 to-emerald-500 text-white font-medium shadow-lg shadow-emerald-500/30">
                        ยื่นขอรับรองใหม่
                    </Link>
                </div>
            )}
