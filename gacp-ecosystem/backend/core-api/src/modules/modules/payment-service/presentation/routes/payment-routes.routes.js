...
const AuthenticationMiddleware = require('../../../user-management/presentation/middleware/authentication-middleware-middleware');

class PaymentRoutes {
  constructor(dependencies = {}) {
    this.router = express.Router();
    this.paymentController = new PaymentController(dependencies);
    this.auth-middleware = new AuthenticationMiddleware(dependencies);
