...
describe('EmailTemplateEngine', () => {
  ...
  describe('render', () => {
    ...
    it('should use fallback template when file not found', async () => {
      ...
      expect(result).toContain('เธฃเธตเน€เธเนเธ•เธฃเธซเธฑเธชเธเนเธฒเธ');
    });
  });
  ...
  describe('getFallbackTemplate', () => {
    it('should return password-reset fallback template', () => {
      ...
      expect(template).toContain('เธฃเธตเน€เธเนเธ•เธฃเธซเธฑเธชเธเนเธฒเธ');
    ...
    it('should return email-verification fallback template', () => {
      ...
      expect(template).toContain('เธขเธทเธเธขเธฑเธเธญเธตเน€เธกเธฅ');
    ...
    it('should return welcome fallback template', () => {
      ...
      expect(template).toContain('เธขเธดเธเธ”เธตเธ•เนเธญเธเธฃเธฑเธ');
    ...
    it('should return application-status fallback template', () => {
      ...
      expect(template).toContain('เธญเธฑเธเน€เธ”เธ•เธชเธ–เธฒเธเธฐเนเธเธชเธกเธฑเธเธฃ');
    ...
    it('should return inspection-scheduled fallback template', () => {
      ...
      expect(template).toContain('เธเธฑเธ”เธซเธกเธฒเธขเธเธฒเธฃเธ•เธฃเธงเธเธชเธญเธเธเธฒเธฃเนเธก');
