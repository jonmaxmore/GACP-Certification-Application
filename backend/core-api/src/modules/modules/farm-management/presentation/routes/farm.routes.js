...
function createFarmRoutes(farmController, auth-middleware, validators) {
   ...
   * GET /api/farms
   */
  farmerRouter.get('/', auth-middleware.authenticateFarmer, (req, res) =>
   ...
   * GET /api/farms/:id
   */
  farmerRouter.get('/:id', auth-middleware.authenticateFarmer, (req, res) =>
   ...
   */
  farmerRouter.post('/:id/submit', auth-middleware.authenticateFarmer, (req, res) =>
  ...
  dtamRouter.get(
    ...
    auth-middleware.requireAnyPermission(['view_applications', 'review_applications']),
  ...
  dtamRouter.post(
    '/:id/start-review',
    auth-middleware.authenticateDTAMStaff,
    auth-middleware.requirePermission('review_applications'),
  ...
  dtamRouter.post(
    '/:id/approve',
    auth-middleware.authenticateDTAMStaff,
    auth-middleware.requirePermission('approve_applications'),
  ...
  dtamRouter.post(
    '/:id/reject',
    auth-middleware.authenticateDTAMStaff,
    auth-middleware.requirePermission('reject_applications'),
