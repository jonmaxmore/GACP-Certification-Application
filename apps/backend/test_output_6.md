...
[TEST DEBUG] MongoMemoryServer started at: mongodb://127.0.0.1:64947/
...
[33mwarn[39m: Email configuration missing - notifications will be logged only {"service":"gacp-backend","timestamp":"2025-12-06T01:03:55.288Z"}
[33mwarn[39m: No config file found at C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend\config\config.test.json, using defaults and environment variables {"service":"config","timestamp":"2025-12-06T01:03:55.504Z"}
[32minfo[39m: Configuration loaded successfully {"config":{"app":{"environment":"test","name":"Botanical Audit Framework","version":"1.0.0"},"auth":{"jwtExpiration":"24h","jwtSecret":"********","refreshTokenExpiration":"7d"},"features":{"enableAI":false,"enableQuestionnaires":true,"enableReporting":true,"enableSocketNotifications":true,"enableStandardsComparison":true,"enableTraceability":true},"logging":{"combinedLogPath":"./logs/combined.log","errorLogPath":"./logs/error.log","format":"combined","level":"info"},"modules":{"analytics":{},"farmManagement":{},"questionnaires":{},"reporting":{},"standards":{},"traceability":{}},"mongodb":{"options":{"useNewUrlParser":true,"useUnifiedTopology":true},"reconnectAttempts":5,"reconnectInterval":5000,"uri":"mongodb://127.0.0.1:64947/"},"performance":{"cacheEnabled":true,"compressionThreshold":1024,"slowRequestThreshold":1000},"redis":{"enabled":false,"ttl":86400},"server":{"host":"localhost","port":5000,"shutdownTimeout":30000},"storage":{"localPath":"./test-uploads","maxFileSize":10485760,"type":"local"}},"service":"config","timestamp":"2025-12-06T01:03:55.507Z"}
[33mwarn[39m: Cache service disabled {"service":"gacp-backend","timestamp":"2025-12-06T01:03:55.508Z"}
[32minfo[39m: Queue Service disabled in test mode {"service":"gacp-backend","timestamp":"2025-12-06T01:03:55.509Z"}
[TEST DEBUG] server.js loaded.
[TEST DEBUG] Setup complete.
(node:9756) [MONGOOSE] Warning: Duplicate schema index on {"email":1} found. This is often due to declaring an index using both "index: true" and "schema.index()". Please remove the duplicate index definition.
(Use `node --trace-warnings ...` to show where the warning was created)
::ffff:127.0.0.1 - - [06/Dec/2025:01:03:55 +0000] "POST /api/auth-farmer/register HTTP/1.1" 201 346 "-" "-"
::ffff:127.0.0.1 - - [06/Dec/2025:01:03:55 +0000] "POST /api/auth-farmer/login HTTP/1.1" 200 514 "-" "-"
::ffff:127.0.0.1 - - [06/Dec/2025:01:03:55 +0000] "POST /api/v2/establishments HTTP/1.1" 201 411 "-" "-"
  console.error
...
[32minfo[39m: GACP application created {"applicationId":"693380fbf44e80f96b1f2bd2","applicationNumber":"APP-20251206-2709","farmerId":"693380fbf44e80f96b1f2bbd","riskLevel":"low","service":"gacp-backend","timestamp":"2025-12-06T01:03:56.008Z"}
::ffff:127.0.0.1 - - [06/Dec/2025:01:03:56 +0000] "POST /api/v2/applications HTTP/1.1" 200 68 "-" "-"
::ffff:127.0.0.1 - - [06/Dec/2025:01:03:56 +0000] "GET /api/v2/applications/693380fbf44e80f96b1f2bd2/review HTTP/1.1" 404 190 "-" "-"
  console.error
    [DEBUG] authenticateFarmer called. CWD: C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend
...
::ffff:127.0.0.1 - - [06/Dec/2025:01:03:56 +0000] "GET /api/v2/applications/693380fbf44e80f96b1f2bd2 HTTP/1.1" 200 183 "-" "-"
  console.error
    [DEBUG] authenticateFarmer called. CWD: C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend
...
[32minfo[39m: Processing payment confirmation for app 693380fbf44e80f96b1f2bd2, phase phase1 {"service":"gacp-backend","timestamp":"2025-12-06T01:03:56.048Z"}
[32minfo[39m: Payment processed for application 693380fbf44e80f96b1f2bd2 phase phase1 {"service":"gacp-backend","timestamp":"2025-12-06T01:03:56.066Z","transactionId":"TXN-1764983036056"}
::ffff:127.0.0.1 - - [06/Dec/2025:01:03:56 +0000] "POST /api/v2/payments HTTP/1.1" 200 403 "-" "-"
  console.error
    [DEBUG] authenticateFarmer called. CWD: C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend
...
[31merror[39m: Error submitting application {"applicationId":"693380fbf44e80f96b1f2bd2","error":"Cannot read properties of undefined (reading 'location')","service":"gacp-backend","timestamp":"2025-12-06T01:03:56.118Z"}
::ffff:127.0.0.1 - - [06/Dec/2025:01:03:56 +0000] "POST /api/v2/applications/693380fbf44e80f96b1f2bd2/submit HTTP/1.1" 400 84 "-" "-"
  console.error
    Submit Failed: {
      "success": false,
...
[32minfo[39m: Disconnected from MongoDB {"service":"gacp-backend","timestamp":"2025-12-06T01:03:56.139Z"}
FAIL __tests__/integration/GacpGoldenLoop.test.js
  🎯 GACP Golden Loop (Corrected Workflow)
    × should complete the full GACP workflow successfully (600 ms)
...
Snapshots:   0 total
Time:        2.862 s, estimated 3 s
Ran all test suites matching /__tests__\\integration\\GacpGoldenLoop.test.js/i.
[32minfo[39m: Loaded MongoDB config from app-config.json {"service":"mongodb","timestamp":"2025-12-06T01:03:57.185Z"}
[32minfo[39m: MongoDB manager initialized with URI: mongodb+srv://gacp-premierprime:******@thai-gacp.re1651p.mongodb.net/gacp-development?retryWrites=true&w=majority&ssl=true&authSource=admin {"service":"mongodb","timestamp":"2025-12-06T01:03:57.186Z"}
