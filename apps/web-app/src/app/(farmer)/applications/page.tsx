        ...
        <div style={{ minHeight: "100vh", backgroundColor: colors.background, fontFamily: "'Sarabun', sans-serif" }}>
            <div style={{ background: `linear-gradient(135deg, ${colors.heroStart}, ${colors.heroEnd})`, padding: "24px", color: "#FFF" }}>
                <div style={{ maxWidth: "720px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                        ...
                        <h1 style={{ fontSize: "20px", fontWeight: 700 }}>คำขอของฉัน</h1>
                    </div>
                    <Link href="/applications/new" style={{ padding: "10px 16px", backgroundColor: colors.primary, color: "#FFF", borderRadius: "10px", textDecoration: "none", fontSize: "14px", fontWeight: 600 }}>+ ยื่นคำขอ</Link>
                </div>
            </div>
            ...
            <div style={{ maxWidth: "720px", margin: "0 auto", padding: "24px" }}>
                <div style={{ backgroundColor: colors.card, borderRadius: "16px", padding: "48px", textAlign: "center", boxShadow: "0 4px 12px rgba(0,0,0,0.04)" }}>
                    ...
                    <h2 style={{ color: colors.textDark, marginBottom: "8px" }}>ยังไม่มีคำขอ</h2>
                    <p style={{ color: colors.textGray, fontSize: "14px", marginBottom: "20px" }}>เริ่มต้นยื่นคำขอรับรองมาตรฐาน GACP</p>
                    <Link href="/applications/new" style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "12px 24px", backgroundColor: colors.primary, color: "#FFF", borderRadius: "12px", textDecoration: "none", fontWeight: 600 }}>
