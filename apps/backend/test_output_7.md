...
[TEST DEBUG] MongoMemoryServer started at: mongodb://127.0.0.1:54564/
...
[33mwarn[39m: Email configuration missing - notifications will be logged only {"service":"gacp-backend","timestamp":"2025-12-06T01:14:19.269Z"}
[33mwarn[39m: No config file found at C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend\config\config.test.json, using defaults and environment variables {"service":"config","timestamp":"2025-12-06T01:14:19.480Z"}
[32minfo[39m: Configuration loaded successfully {"config":{"app":{"environment":"test","name":"Botanical Audit Framework","version":"1.0.0"},"auth":{"jwtExpiration":"24h","jwtSecret":"********","refreshTokenExpiration":"7d"},"features":{"enableAI":false,"enableQuestionnaires":true,"enableReporting":true,"enableSocketNotifications":true,"enableStandardsComparison":true,"enableTraceability":true},"logging":{"combinedLogPath":"./logs/combined.log","errorLogPath":"./logs/error.log","format":"combined","level":"info"},"modules":{"analytics":{},"farmManagement":{},"questionnaires":{},"reporting":{},"standards":{},"traceability":{}},"mongodb":{"options":{"useNewUrlParser":true,"useUnifiedTopology":true},"reconnectAttempts":5,"reconnectInterval":5000,"uri":"mongodb://127.0.0.1:54564/"},"performance":{"cacheEnabled":true,"compressionThreshold":1024,"slowRequestThreshold":1000},"redis":{"enabled":false,"ttl":86400},"server":{"host":"localhost","port":5000,"shutdownTimeout":30000},"storage":{"localPath":"./test-uploads","maxFileSize":10485760,"type":"local"}},"service":"config","timestamp":"2025-12-06T01:14:19.483Z"}
[33mwarn[39m: Cache service disabled {"service":"gacp-backend","timestamp":"2025-12-06T01:14:19.484Z"}
[32minfo[39m: Queue Service disabled in test mode {"service":"gacp-backend","timestamp":"2025-12-06T01:14:19.485Z"}
[TEST DEBUG] server.js loaded.
[TEST DEBUG] Setup complete.
(node:11260) [MONGOOSE] Warning: Duplicate schema index on {"email":1} found. This is often due to declaring an index using both "index: true" and "schema.index()". Please remove the duplicate index definition.
(Use `node --trace-warnings ...` to show where the warning was created)
::ffff:127.0.0.1 - - [06/Dec/2025:01:14:19 +0000] "POST /api/auth-farmer/register HTTP/1.1" 201 346 "-" "-"
::ffff:127.0.0.1 - - [06/Dec/2025:01:14:19 +0000] "POST /api/auth-farmer/login HTTP/1.1" 200 514 "-" "-"
::ffff:127.0.0.1 - - [06/Dec/2025:01:14:19 +0000] "POST /api/v2/establishments HTTP/1.1" 201 411 "-" "-"
  console.error
...
[32minfo[39m: GACP application created {"applicationId":"6933836bc0a3d7d467e895e4","applicationNumber":"APP-20251206-9063","farmerId":"6933836bc0a3d7d467e895cd","riskLevel":"low","service":"gacp-backend","timestamp":"2025-12-06T01:14:19.991Z"}
::ffff:127.0.0.1 - - [06/Dec/2025:01:14:19 +0000] "POST /api/v2/applications HTTP/1.1" 200 68 "-" "-"
::ffff:127.0.0.1 - - [06/Dec/2025:01:14:19 +0000] "GET /api/v2/applications/6933836bc0a3d7d467e895e4/review HTTP/1.1" 404 190 "-" "-"
  console.error
    [DEBUG] authenticateFarmer called. CWD: C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend
...
::ffff:127.0.0.1 - - [06/Dec/2025:01:14:20 +0000] "GET /api/v2/applications/6933836bc0a3d7d467e895e4 HTTP/1.1" 200 183 "-" "-"
  console.error
    [DEBUG] authenticateFarmer called. CWD: C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend
...
[32minfo[39m: Processing payment confirmation for app 6933836bc0a3d7d467e895e4, phase phase1 {"service":"gacp-backend","timestamp":"2025-12-06T01:14:20.037Z"}
[32minfo[39m: Payment processed for application 6933836bc0a3d7d467e895e4 phase phase1 {"service":"gacp-backend","timestamp":"2025-12-06T01:14:20.051Z","transactionId":"TXN-1764983660044"}
::ffff:127.0.0.1 - - [06/Dec/2025:01:14:20 +0000] "POST /api/v2/payments HTTP/1.1" 200 403 "-" "-"
  console.error
    [DEBUG] authenticateFarmer called. CWD: C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend
...
[31merror[39m: Error submitting application {"applicationId":"6933836bc0a3d7d467e895e4","error":"No Officers available for province: Chiang Mai","service":"gacp-backend","timestamp":"2025-12-06T01:14:20.095Z"}
::ffff:127.0.0.1 - - [06/Dec/2025:01:14:20 +0000] "POST /api/v2/applications/6933836bc0a3d7d467e895e4/submit HTTP/1.1" 400 74 "-" "-"
  console.error
    Submit Failed: {
      "success": false,
      "error": "No Officers available for province: Chiang Mai"
    }
...
[32minfo[39m: Disconnected from MongoDB {"service":"gacp-backend","timestamp":"2025-12-06T01:14:20.115Z"}
FAIL __tests__/integration/GacpGoldenLoop.test.js
  🎯 GACP Golden Loop (Corrected Workflow)
    × should complete the full GACP workflow successfully (599 ms)
...
Snapshots:   0 total
Time:        2.865 s, estimated 3 s
Ran all test suites matching /__tests__\\integration\\GacpGoldenLoop.test.js/i.
[32minfo[39m: Loaded MongoDB config from app-config.json {"service":"mongodb","timestamp":"2025-12-06T01:14:21.161Z"}
[32minfo[39m: MongoDB manager initialized with URI: mongodb+srv://gacp-premierprime:******@thai-gacp.re1651p.mongodb.net/gacp-development?retryWrites=true&w=majority&ssl=true&authSource=admin {"service":"mongodb","timestamp":"2025-12-06T01:14:21.163Z"}
