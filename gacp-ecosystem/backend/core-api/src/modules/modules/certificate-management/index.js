 ...
 * @param {Function} auth-middleware - Authentication middleware
 * @returns {Object} - Module components (router, service, controller)
 */
async function initializeCertificateManagement(db, auth-middleware) {
  try {
    ...
    // Initialize routes
    const router = initializeRoutes(certificateController, auth-middleware);
