...
[TEST DEBUG] MongoMemoryServer started at: mongodb://127.0.0.1:60327/
...
[33mwarn[39m: Email configuration missing - notifications will be logged only {"service":"gacp-backend","timestamp":"2025-12-06T01:01:09.927Z"}
[33mwarn[39m: No config file found at C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend\config\config.test.json, using defaults and environment variables {"service":"config","timestamp":"2025-12-06T01:01:10.138Z"}
[32minfo[39m: Configuration loaded successfully {"config":{"app":{"environment":"test","name":"Botanical Audit Framework","version":"1.0.0"},"auth":{"jwtExpiration":"24h","jwtSecret":"********","refreshTokenExpiration":"7d"},"features":{"enableAI":false,"enableQuestionnaires":true,"enableReporting":true,"enableSocketNotifications":true,"enableStandardsComparison":true,"enableTraceability":true},"logging":{"combinedLogPath":"./logs/combined.log","errorLogPath":"./logs/error.log","format":"combined","level":"info"},"modules":{"analytics":{},"farmManagement":{},"questionnaires":{},"reporting":{},"standards":{},"traceability":{}},"mongodb":{"options":{"useNewUrlParser":true,"useUnifiedTopology":true},"reconnectAttempts":5,"reconnectInterval":5000,"uri":"mongodb://127.0.0.1:60327/"},"performance":{"cacheEnabled":true,"compressionThreshold":1024,"slowRequestThreshold":1000},"redis":{"enabled":false,"ttl":86400},"server":{"host":"localhost","port":5000,"shutdownTimeout":30000},"storage":{"localPath":"./test-uploads","maxFileSize":10485760,"type":"local"}},"service":"config","timestamp":"2025-12-06T01:01:10.142Z"}
[33mwarn[39m: Cache service disabled {"service":"gacp-backend","timestamp":"2025-12-06T01:01:10.143Z"}
[32minfo[39m: Queue Service disabled in test mode {"service":"gacp-backend","timestamp":"2025-12-06T01:01:10.144Z"}
[TEST DEBUG] server.js loaded.
[TEST DEBUG] Setup complete.
(node:14640) [MONGOOSE] Warning: Duplicate schema index on {"email":1} found. This is often due to declaring an index using both "index: true" and "schema.index()". Please remove the duplicate index definition.
(Use `node --trace-warnings ...` to show where the warning was created)
::ffff:127.0.0.1 - - [06/Dec/2025:01:01:10 +0000] "POST /api/auth-farmer/register HTTP/1.1" 201 346 "-" "-"
::ffff:127.0.0.1 - - [06/Dec/2025:01:01:10 +0000] "POST /api/auth-farmer/login HTTP/1.1" 200 514 "-" "-"
::ffff:127.0.0.1 - - [06/Dec/2025:01:01:10 +0000] "POST /api/v2/establishments HTTP/1.1" 201 411 "-" "-"
  console.error
...
[32minfo[39m: GACP application created {"applicationId":"693380567398bac65ea47349","applicationNumber":"APP-20251206-9465","farmerId":"693380567398bac65ea47334","riskLevel":"low","service":"gacp-backend","timestamp":"2025-12-06T01:01:10.645Z"}
::ffff:127.0.0.1 - - [06/Dec/2025:01:01:10 +0000] "POST /api/v2/applications HTTP/1.1" 200 68 "-" "-"
::ffff:127.0.0.1 - - [06/Dec/2025:01:01:10 +0000] "GET /api/v2/applications/693380567398bac65ea47349/review HTTP/1.1" 404 190 "-" "-"
  console.error
    [DEBUG] authenticateFarmer called. CWD: C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend
...
::ffff:127.0.0.1 - - [06/Dec/2025:01:01:10 +0000] "GET /api/v2/applications/693380567398bac65ea47349 HTTP/1.1" 200 183 "-" "-"
  console.error
    [DEBUG] authenticateFarmer called. CWD: C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend
...
[32minfo[39m: Processing payment confirmation for app 693380567398bac65ea47349, phase phase1 {"service":"gacp-backend","timestamp":"2025-12-06T01:01:10.690Z"}
[32minfo[39m: Payment processed for application 693380567398bac65ea47349 phase phase1 {"service":"gacp-backend","timestamp":"2025-12-06T01:01:10.705Z","transactionId":"TXN-1764982870697"}
::ffff:127.0.0.1 - - [06/Dec/2025:01:01:10 +0000] "POST /api/v2/payments HTTP/1.1" 200 403 "-" "-"
  console.error
    [DEBUG] authenticateFarmer called. CWD: C:\Users\usEr\Documents\GitHub\GACP-Certification-Application\apps\backend
...
[31merror[39m: Error submitting application {"applicationId":"693380567398bac65ea47349","error":"Missing required documents: application_form, farm_management_plan, cultivation_records, land_rights_certificate","service":"gacp-backend","timestamp":"2025-12-06T01:01:10.718Z"}
::ffff:127.0.0.1 - - [06/Dec/2025:01:01:10 +0000] "POST /api/v2/applications/693380567398bac65ea47349/submit HTTP/1.1" 400 140 "-" "-"
  console.error
    Submit Failed: {
      "success": false,
      "error": "Missing required documents: application_form, farm_management_plan, cultivation_records, land_rights_certificate"
    }

    [0m [90m 295 |[39m
     [90m 296 |[39m         [36mif[39m (submitRes[33m.[39mstatus [33m!==[39m [35m200[39m) {
    [31m[1m>[22m[39m[90m 297 |[39m             console[33m.[39merror([32m'Submit Failed:'[39m[33m,[39m [33mJSON[39m[33m.[39mstringify(submitRes[33m.[39mbody[33m,[39m [36mnull[39m[33m,[39m [35m2[39m))[33m;[39m
     [90m     |[39m                     [31m[1m^[22m[39m
     [90m 298 |[39m         }
     [90m 299 |[39m         expect(submitRes[33m.[39mstatus)[33m.[39mtoBe([35m200[39m)[33m;[39m
     [90m 300 |[39m         console[33m.[39mlog([32m'✅ Application Submitted'[39m)[33m;[39m[0m

      at Object.error (__tests__/integration/GacpGoldenLoop.test.js:297:21)

[32minfo[39m: Disconnected from MongoDB {"service":"gacp-backend","timestamp":"2025-12-06T01:01:10.743Z"}
FAIL __tests__/integration/GacpGoldenLoop.test.js
  🎯 GACP Golden Loop (Corrected Workflow)
    × should complete the full GACP workflow successfully (569 ms)
...
System.Management.Automation.RemoteException
    ...
    Received: 400
System.Management.Automation.RemoteException
    [0m [90m 297 |[39m             console[33m.[39merror([32m'Submit Failed:'[39m[33m,[39m [33mJSON[39m[33m.[39mstringify(submitRes[33m.[39mbody[33m,[39m [36mnull[39m[33m,[39m [35m2[39m))[33m;[39m
     [90m 298 |[39m         }
    [31m[1m>[22m[39m[90m 299 |[39m         expect(submitRes[33m.[39mstatus)[33m.[39mtoBe([35m200[39m)[33m;[39m
     [90m     |[39m                                  [31m[1m^[22m[39m
     [90m 300 |[39m         console[33m.[39mlog([32m'✅ Application Submitted'[39m)[33m;[39m
     [90m 301 |[39m
     [90m 302 |[39m         [90m// ============================================[39m[0m
System.Management.Automation.RemoteException
      at Object.toBe (__tests__/integration/GacpGoldenLoop.test.js:299:34)
System.Management.Automation.RemoteException
...
[32minfo[39m: Loaded MongoDB config from app-config.json {"service":"mongodb","timestamp":"2025-12-06T01:01:11.789Z"}
[32minfo[39m: MongoDB manager initialized with URI: mongodb+srv://gacp-premierprime:******@thai-gacp.re1651p.mongodb.net/gacp-development?retryWrites=true&w=majority&ssl=true&authSource=admin {"service":"mongodb","timestamp":"2025-12-06T01:01:11.790Z"}
