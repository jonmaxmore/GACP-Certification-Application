...
const establishmentsRouter = require('../../../modules/modules/establishment');
...
router.use('/licenses', require('./licenses')); // License API - กท.11/13/16 verification
...
router.use('/auth-staff', require('../../../modules/modules/auth-dtam/routes/dtam-auth')); // Staff Authentication API
